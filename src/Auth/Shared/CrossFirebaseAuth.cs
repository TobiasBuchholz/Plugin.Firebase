...
/// <summary>
/// Cross-platform entry point for Firebase Authentication.
/// </summary>
public sealed class CrossFirebaseAuth
{
    private static Lazy<IFirebaseAuth> _implementation = new Lazy<IFirebaseAuth>(
        CreateInstance,
...
#pragma warning restore IDE0022 // Use expression body for methods
    ...
    public static void Dispose()
    {
        if(_implementation != null && _implementation.IsValueCreated) {
            ...
            _implementation = new Lazy<IFirebaseAuth>(
                CreateInstance,
                LazyThreadSafetyMode.PublicationOnly
            );
        }
