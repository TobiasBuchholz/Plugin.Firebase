...
/// <summary>
/// Wraps a native iOS Firestore write batch.
/// </summary>
public sealed class WriteBatchWrapper : IWriteBatch
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WriteBatchWrapper"/> class.
    /// </summary>
    /// <param name="writeBatch">The native iOS write batch to wrap.</param>
