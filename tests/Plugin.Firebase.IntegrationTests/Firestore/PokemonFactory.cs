...
public static class PokemonFactory
{
    ...
    private static Pokemon CreateIvysaur()
    {
        return new Pokemon(
            id: "2",
            name: "Ivysaur",
    ...
    private static Pokemon CreateVenusaur()
    {
        return new Pokemon(
            id: "3",
            name: "Venusaur",
    ...
    public static Pokemon CreateCharmeleon()
    {
        return new Pokemon(
            ...
            moves: new List<string> { "Scratch", "Body-Slam", "Fire-Punch" },
            firstSightingLocation: new SightingLocation(52.5042112, 13.5290173),
            otherProperties: new Dictionary<string, long> { { "legs", 4 }, { "colors", 3 } },
    ...
    private static Pokemon CreateBlastoise()
    {
        return new Pokemon(
            id: "9",
            name: "Blastoise",
